...
void SCENE_Barrel_Create()
{
    ...
    //SCENE_Barrel_BitmapWidth = barrel_bump.Width;
    //SCENE_Barrel_BitmapHeight = barrel_bump.Height;
...
void SCENE_Barrel()
{
    ...
    void initTable()
    {
        ...
        //VDP_setPaletteColors(0, barrel_bump.Palette, 16);
    ...
    //VDP_loadBMPTileData((u32*)barrel_bump.Data, 1, w/8, h/8, w/8);
